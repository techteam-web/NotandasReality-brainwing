...
export const BUILDING_VIEWS = {
  "notan-dc": {
    ...
    headerLogoClass:
      ...
      headerSubClass:"lg:-mt-14 lg:text-[5px] xl:text-[-23px]  xl:mt-10 2xl:-mt-5 2xl:text-[8px] 2xl:text-bold 3xl:mt-5 3xl:text-[10px] 4xl:-mt-7 4xl:text-[16px]",
    amenityClass:
    ...
    amenityListClass: "max-w-lg xl:w-[17rem] lg:w-[15rem] 2xl:w-[20rem] 3xl:w-[26rem] 4xl:w-[33rem]",
    amenityItemClass:
  ...
  "notan-jewel": {
    ...
    headerClass:
      "left-80 top-36 md:top-127 2xl:left-59 2xl:top-80 xl:left-57 xl:top-34 lg:left-53 lg:top-12 3xl:left-95 3xl:top-30 4xl:left-90 4xl:top-150",
       headerSubClass:"lg:-mt-14 lg:text-[7px] xl:text-[-23px]  xl:mt-8 2xl:-mt-5 2xl:text-[8px] 2xl:text-bold 3xl:mt-5 3xl:text-[10px] 4xl:-mt-7 4xl:text-[16px]",
    headerLogoClass:
    ...
    amenityListClass: "max-w-lg lg:w-[14rem] xl:w-[23rem] 2xl:w-[20rem] 3xl:w-[32rem] 4xl:w-[33rem]",
    amenityItemClass:
  ...
  "notan-space": {
    ...
    headerLogoClass:
      "my-[-30%] w-64 sm:w-72 md:w-100 lg:w-36 xl:w-68 2xl:w-76 4xl:w-130",
        headerSubClass:"lg:-mt-16 lg:text-[8px] xl:mt-6 2xl:mt-1 3xl:mt-5 3xl:text-[13px] 4xl:mt-4 4xl:text-[16px]",
    asideClass:
    ...
    amenityListClass: "max-w-lg lg:w-[12rem] xl:w-[19rem] 3xl:w-[28rem] 4xl:w-[33rem]",
    amenityItemClass:
  ...
  "notan-terrace": {
    ...
    headerClass:
      "left-80 top-36 md:top-127 2xl:left-60 2xl:top-70 xl:left-45  xl:top-55 lg:left-17 lg:top-40 3xl:left-90 3xl:top-105 4xl:left-137 4xl:top-150 ",
    headerLogoClass:
      "my-[-30%] w-64 sm:w-72 md:w-100 lg:w-76 xl:w-68 2xl:w-76 4xl:w-130",
    amenityClass:
      "w-[calc(100%-2.5rem)] max-w-xl sm:max-w-2xl lg:max-w-3xl bottom-55 left-75 md:bottom-15 md:left-15 lg:bottom-15 lg:left-15 2xl:left-55 3xl:left-39 4xl:left-120 xl:left-27",
  ...
  "notan-crown": {
    ...
    headerClass:
      "left-80 top-36 md:top-127 2xl:left-90 2xl:top-105 xl:left-79 xl:top-100 lg:left-40 lg:top-90 3xl:left-117 3xl:top-127 4xl:left-137 4xl:top-150",
    headerLogoClass:
