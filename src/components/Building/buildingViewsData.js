...
export const BUILDING_VIEWS = {
  "notan-dc": {
    ...
    amenityItemClass:
      "lg:text-[11px] xl:text-[14px] 2xl:text-[15px] 3xl:text-[19px] 4xl:text-[25px] 5xl:text-[30px]",
    amenityClass:
      "laptop-sm:top-[40%] laptop-sm:right-[-12%] mac-14:-right-[7%] imac-24:right-[3.3%] imac-24:top-[40%] ultrawide:right-[7.8%] 5xl:top-[40%] 5xl:right-[12%] w-[calc(100%-2.5rem)] max-w-xl sm:max-w-2xl lg:max-w-3xl mp:top-[40%] mp:-right-[8.6%] lg:top-60 lg:-right-40 2xl:-right-17 2xl:top-[40%] 3xl:top-110 3xl:right-[1.8%] 4xl:top-155 4xl:right-43 xl:-right-28 xl:top-73",
  ...
  "notan-terrace": {
    ...
    headerClass:
      "laptop-sm:left-[11.1%] laptop-sm:top-[13%] mac-14:left-[11.3%] md:top-127 mp:top-35 2xl:left-[17%] 2xl:top-[16%] xl:left-40 xl:top-20 lg:left-31 lg:top-8  3xl:left-90 3xl:top-45 4xl:left-115 4xl:top-60 5xl:left-[17%] 5xl:top-[20%]",
    headerLogoClass:
    ...
    nMarkFill: "black",
    amenityClass:
      "laptop-sm:top-[40%] laptop-sm:-left-[7%] mac-14:-left-[1%] mac-14:top-[37%]  w-[calc(100%-2.5rem)] max-w-xl sm:max-w-2xl lg:max-w-3xl bottom-55 left-75 mp:top-[38%] mp:-left-6 md:bottom-15 md:left-15 lg:bottom-55 lg:-left-25 2xl:left-15 2xl:top-[40%] 3xl:left-[9%] 3xl:top-110 4xl:left-90 4xl:top-140 xl:-left-7 xl:top-63 5xl:left-[15%] 5xl:top-[38%]",
    amenityListClass:
      "max-w-lg lg:w-[26rem] xl:w-[30rem] 2xl:w-[34rem] 3xl:w-[42rem] 4xl:w-[52rem]",
    amenityItemClass:
