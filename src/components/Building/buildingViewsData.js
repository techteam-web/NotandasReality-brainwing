...
export const BUILDING_VIEWS = {
  "notan-dc": {
    ...
    headerClass: "left-80 top-36 md:top-127 2xl:left-74 2xl:top-107 xl:left-55  xl:top-90 lg:left-20 lg:top-70 3xl:left-102 3xl:top-105 4xl:left-137 4xl:top-150",
    amenityClass: "bottom-55 left-75 md:bottom-15 md:left-15 lg:bottom-15 lg:left-15 lg:h-35 2xl:h-65 2xl:left-57 2xl:top-137 3xl:top-150 3xl:left-87 3xl:h-75 4xl:top-190 4xl:left-148 4xl:h-76 xl:h-62 xl:left-32 xl:top-115 ",
  ...
  "notan-jewel": {
    ...
    amenityClass: "bottom-55 left-75 md:bottom-15 md:left-15 lg:bottom-15 lg:left-15 lg:h-35 2xl:left-55 2xl:top-133 2xl:h-60 3xl:top-165 3xl:left-87 4xl:bottom-70 4xl:left-90 xl:h-52 xl:left-27 ",
    headerClass: "left-80 top-36 md:top-127 2xl:left-59 2xl:top-90 xl:left-38 xl:top-74 lg:left-23 lg:top-54 3xl:left-89 3xl:top-127 4xl:left-90 4xl:top-150",
  ...
  "notan-space": {
   ...
   amenityClass: "bottom-55 left-75 md:bottom-15 md:left-15 lg:bottom-15 lg:left-15 lg:h-35 2xl:h-57 2xl:left-60 2xl:top-117 3xl:top-145 3xl:left-90 4xl:bottom-70 4xl:left-90 xl:h-52 xl:left-37 ",
    headerClass: "left-80 top-36 md:top-127 2xl:left-67 2xl:top-90 xl:left-55 xl:top-74  lg:left-23 lg:top-54 3xl:left-95 3xl:top-109 4xl:left-90 4xl:top-150",
  ...
  "notan-crown": {
    ...
    headerClass: "left-80 top-36 md:top-127 2xl:left-74 2xl:top-105 xl:left-60 xl:top-100 lg:left-20 lg:top-70 3xl:left-97 3xl:top-127 4xl:left-137 4xl:top-150",
