...
export const BUILDING_VIEWS = {
  ...
  "notan-crown": {
    ...
    headerClass:
      "left-80 top-36 md:top-127 2xl:left-90 2xl:top-105 xl:left-79 xl:top-100 lg:left-40 lg:top-90 3xl:left-108 3xl:top-127 4xl:left-137 4xl:top-150",
    headerLogoClass: "w-44 sm:w-52 md:w-72 lg:w-56 xl:w-48 2xl:w-56 2xl:h-20 3xl:h-26 4xl:w-96",
    asideClass:
      "left-[25%] top-[20%] md:right-12 md:w-44 2xl:top-[10%] xl:top-[10%]  lg:top-[5%] 3xl:top-[14%] 4xl:top-[10%]",
    nMarkFill: "black",
    amenityClass:
