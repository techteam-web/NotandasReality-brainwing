...
const NuthandasLogoAnimated = ({ className }) => {
    ...
    let ctx = gsap.context(() => {
      ...
      paths.forEach((path) => {
        ...
        // Let's fade in text softly after the logo is drawn
           ...
           gsap.set(path, { opacity: 0, fill: "#DAA520" });
           gsap.to(path, {
             opacity: 1,
             duration: 1.5,
             delay: 2,
  ...
  return (
    ...
    >
      <g transform="translate(0.000000,306.000000) scale(0.100000,-0.100000)" stroke="none">
      ...
      <text x="182.5" y="342" text-anchor="middle" font-family="Montserrat, Arial, sans-serif" font-weight="700" font-size="28" letter-spacing="8">NOTANDAS</text>
      <text x="182.5" y="376" text-anchor="middle" font-family="Montserrat, Arial, sans-serif" font-weight="300" font-size="24" letter-spacing="10">REALITY</text>
    </svg>
