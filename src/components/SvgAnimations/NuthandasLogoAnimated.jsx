...
const NuthandasLogoAnimated = ({ className, style }) => {
  ...
  return (
    ...
    >
      ...
      {/* The wordmark is pinned to exactly 340 user units wide with
          textLength/lengthAdjust and sits inside a 400-wide viewBox, leaving 30
          units of padding on each side. Montserrat is not loaded anywhere in the
          app, so this text always renders in a fallback face whose metrics differ
          per device - pinning the width is what guarantees no letter is ever
